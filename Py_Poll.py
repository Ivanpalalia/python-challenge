...
with open(file_path, 'r') as file_handle:
    ...
    #loop through by creating election dictionary by going over each row
    ...
    #then, looping through dictionary keys to get win percentage
    ...
    #finally, finding the winner using key lookup for max value
